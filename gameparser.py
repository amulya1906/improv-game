...
def filter_words(words, skip_words):
    ...
    """
    new_words = [item for item in words if item not in skip_words]
...
def normalise_input(user_input):
    ...
    words_spaces=no_punct.strip()
    words_split=words_spaces.split()
    words_list=[]
    for words in words_split:
        words_list.append(words)
    return filter_words(words_list, skip_words)
